...
def truncated_map(out, q_rel):
    ...
    # q_rel is also a dictionary with query ids as keys, but the values are lists of all duplicate ids. It does not
    # contain NIL.
    ...
    #          }
    #
    #    q_rel = {'test1': [], 'test2': [], 'test3': ['true', 'true', 'true'], 'test4': ['true', 'true', 'true'],
    # 'test5': ['true', 'true', 'true'], 'test6': ['true', 'true', 'true'], 'test7': ['true', 'true', 'true'],
    # 'test8': ['true', 'true', 'true'], 'test9': ['true', 'true', 'true'], 'test10': ['true', 'true', 'true']}
    #
    #    num_queries = 10
